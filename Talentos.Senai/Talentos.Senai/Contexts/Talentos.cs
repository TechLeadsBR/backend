...
namespace Talentos.Senai.Contexts
{
    public partial class Talentos : DbContext
    {
        public Talentos()
        {
        }

        public Talentos(DbContextOptions<Talentos> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                string database = "DESKTOP-M396CC9";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Administrador>(entity =>
            {
                entity.HasKey(e => e.IdAdministrador)
                    .HasName("PK__Administ__2B3E34A89FEB9F89");
            ...
            modelBuilder.Entity<Aluno>(entity =>
            {
                entity.HasKey(e => e.IdAluno)
                    .HasName("PK__Aluno__8092FCB3316083AB");
            ...
            modelBuilder.Entity<Empresa>(entity =>
            {
                entity.HasKey(e => e.IdEmpresa)
                    .HasName("PK__Empresa__5EF4033E78248AED");
            ...
            modelBuilder.Entity<Endereco>(entity =>
            {
                entity.HasKey(e => e.IdEndereco)
                    .HasName("PK__Endereco__0B7C7F1751BC77F1");
            ...
            modelBuilder.Entity<Estagio>(entity =>
            {
                entity.HasKey(e => e.IdEstagio)
                    .HasName("PK__Estagio__C70AD76C02780351");
            ...
            modelBuilder.Entity<ExperienciaProfissional>(entity =>
            {
                entity.HasKey(e => e.IdExperienciaProfissional)
                    .HasName("PK__Experien__7772B9DEF8C81024");
            ...
            modelBuilder.Entity<FormacaoAcademica>(entity =>
            {
                entity.HasKey(e => e.IdFormacaoAcademica)
                    .HasName("PK__Formacao__3EC2A8C2ED8474B4");
            ...
            modelBuilder.Entity<Idioma>(entity =>
            {
                entity.HasKey(e => e.IdIdioma)
                    .HasName("PK__Idioma__C867BD36ED854176");
            ...
            modelBuilder.Entity<InscricaoEmprego>(entity =>
            {
                entity.HasKey(e => e.IdInscricaoEmprego)
                    .HasName("PK__Inscrica__0BAD2A2982B23C07");
            ...
            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                entity.HasKey(e => e.IdTipoUsuario)
                    .HasName("PK__TipoUsua__CA04062BB06B6DFD");
            ...
            modelBuilder.Entity<VagaEmprego>(entity =>
            {
                entity.HasKey(e => e.IdVagaEmprego)
                    .HasName("PK__VagaEmpr__0BF741AF8C515D76");
